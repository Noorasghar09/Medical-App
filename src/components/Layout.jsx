...
const menuItems = [
  ...
  { text: 'Voice Agent', icon: <MicIcon />, path: '/voice-agent' },
...
const Layout = () => {
  ...
  const { isConnected, currentAgent } = useVoice();
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1 }}>
            {menuItems.find(item => item.path === location.pathname)?.text || 'Medical Voice Agent'}
          </Typography>
